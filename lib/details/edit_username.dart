...
class _EditusernameState extends State<Editusername> {
  ...
  void setusername(String username, current_password) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    var action = prefs.getString("Authorization");
    try{
      Response response = await post(Uri.parse("http://"+Host+"/auth/users/set_username/"),
          headers: {
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ElevatedButton(
                                onPressed: () {
                                  setusername(usernameController.text.toString(), currentpasswordController.text.toString());
                                },
